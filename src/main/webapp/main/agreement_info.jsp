...
<div class="visual_title">
    <div class="img_area">
        <img src="./images/bnr_agreement_main.jpg" title="이용약관" alt="이용약관" />
    </div>
    <div class="visual_gon">
        <ul class="title_inner_a">
            <li>
                <h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV93cmlzdHdhdGNoX2NsYXNzaWNfZ2wvc2VydmljZS9hZ3JlZW1lbnQuaHRtbA==" >이용약관</span></h2>
            </li>
        </ul>
    </div>
</div>
<div class="Pt60">
    제1조(목적)<br />
이 약관은 주식회사 00(이하 "회사"라 한다)가 운영하는 해당 쇼핑몰 (이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br />
...
<br />
③ "회원’"라 함은 “몰”에 회원가입을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.<br />
<br />
④ "비회원"이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.<br />
<br />
<br />
제3조 (약관 등의 명시와 설명 및 개정)<br />
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소가 있는 곳의 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․전자우편주소, 사업자등록번호 등을 이용자가 쉽게 알 수 있도록 "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br />
<br />
...
② 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “몰”은 제8조에 정한 방법으로 이용자에게 통지하도록 합니다.<br />
<br />
<br />
제6조(회원가입)<br />
...
② 이용자는 재화 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br />
  ...
  5. 통신판매업자에게 회복할 수 없는 중대한 피해가 예상되는 경우로서 사전에 해당 거래에 대하여 별도로 그 사실을 고지하고 소비자의 서면(전자문서를 포함한다)에 의한 동의를 받은 경우<br />
<br />
③ "몰"의 판매물품 중 미가공 신선식품은 제2항 제5호에 해당하는 경우로 청약철회가 제한됩니다.<br />
<br />
...
③ “몰”은 이용자의 개인정보를 수집•이용하는 때에는 당해 이용자에게 그 목적을 고지하고 동의를 받습니다. 다만, 계약이행에 필요한 이용에 대하여는 개인정보취급방침에 고지하고 이용할 수 있습니다.<br />
...
⑤ “몰”이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 합니다.<br />
...
⑦ “몰”은 개인정보 보호를 위하여 이용자의 개인정보를 취급하는 자를 최소한으로 제한하여야 합니다.<br />
...
③ “몰”은 이용자가 동의하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.<br />
<br />
<br />
...
<br />
제23조(게시판의 이용)<br />
① 회사는 사이트 내에서 회원들이 지식을 공유할 수 있는 게시판을 운영하거나 일정한 자격을 가진 회원들이 이를 운영하도록 할 수 있습니다.<br />
② 회사의 게시판에 회원이 등록한 게시물의 저작권은 제3자의 권리를 침해하지 않는 한 등록한 회원에게 속합니다. 회사는 회원이 등록한 게시물을 검색노출, 판촉, 홍보 및 기타의 자료로 무상 사용할 수 있습니다. 다만, 회사는 등록한 회원이 게시물의 삭제와 함께 사용중지를 요청한 경우에는 즉시 사용을 중지합니다.<br />
③ 회사는 다음 각호에 해당하는 내용의 게시물에 대하여 삭제, 열람제한, 쓰기 금지 등의 조치를 취할 수 있습니다.<br />
1. 공공질서나 미풍양속에 위배되는 내용<br />
2. 불법물, 음란물 또는 청소년유해매체물의 게시 등록 또는 이와 관련된 물품의 홍보, 사이트 링크 행위<br />
3. 타인의 권리나 개인정보, 명예, 신용 기타 정당한 이익을 침해하는 내용을 포함하는 경우<br />
4. 범죄행위와 관련된 내용을 포함하는 경우<br />
5. 허위 또는 과장 광고 내용을 포함하는 경우<br />
6. 정보통신 설비의 오동작을 유발하거나, 컴퓨터 바이러스 또는 데이터를 포함하는 경우<br />
7. 게시판의 이용목적에 위배되는 경우<br />
8. 기타 본 약관 및 대한민국 법령에 위반되는 내용을 포함한 경우<br />
<br />
<br />
제24조(분쟁해결)<br />
...
제25조(회사의 면책)<br />
<br />
① 회사는 천재지변 또는 이에 준하는 불가항력, 정보통신설비의 보수점검, 교체 또는 고장, 통신의 두절 등으로 인하여 일시적 또는 종국적으로 서비스를 제공할 수 없는 경우, 서비스 제공 책임이 면책됩니다. 이 경우 회사는 회사가 제공하는 사이트 화면에 게시하거나 기타의 방법으로 회원들에게 통지합니다.<br />
<br />
② 회사는 서비스 이용자 또는 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여 책임을 지지 않습니다.<br />
<br />
③ 회사는 회원이 다른 회원이 게재한 정보, 자료, 사실의 정확성 등을 신뢰함으로써 입은 손해에 대하여 책임을 지지 않습니다.<br />
<br />
<br />
제26조(재판권 및 준거법)<br />
① “몰”과 이용자 간에 발생한 전자상거래 분쟁에 관한 소송은 회사의 본사 주소지의 법원을 전속관할로 합니다.<br />
